...
X_embedded = pickle.load( open( "experement24_studytest_tsne.p", "rb" ) )

plot_vs_y(y, X_embedded, "experement24_study.png")

pam_names = get_pam_names(notrea_dataset)
plot_vs_y(pam_names, X_embedded, "experement24_pam_names.png")

plot_vs_y(dataset["pCR"].to_numpy(), X_embedded, "experement24_pCR.png")
plot_vs_y(dataset["DFS"].to_numpy(), X_embedded, "experement24_DFS.png")
plot_vs_y(dataset["RFS"].to_numpy(), X_embedded, "experement24_RFS.png")
plot_vs_y(dataset["posOutcome"].to_numpy(), X_embedded, "experement24_posOutcome.png")
plot_vs_y(dataset["radio"].to_numpy(), X_embedded, "experement24_radio.png")
plot_vs_y(dataset["surgery"].to_numpy(), X_embedded, "experement24_surgey.png")
plot_vs_y(dataset["chemo"].to_numpy(), X_embedded, "experement24_chemo.png")
plot_vs_y(dataset["hormone"].to_numpy(), X_embedded, "experement24_hormone.png")
