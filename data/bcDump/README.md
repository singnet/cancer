## lz compressed expression matrices are in an aws bucket at the following links:  
- [example15bmc.tar.xz](https://https://snet-bio-data.s3-us-west-2.amazonaws.com/example15bmc/example15bmc.tar.xz): 17 expression matrices with batch mean centered (bmc) normalization
