...
class Generator(nn.Module):
    def __init__(self, opt):
        ...
        input_dim = opt.latent_dim + opt.n_classes + (opt.code_parts*opt.code_dim)
...
class Discriminator(nn.Module):
    def __init__(self, opt):
        ...
        self.latent_layer = nn.Sequential(nn.Linear(512, (opt.code_parts*opt.code_dim)), nn.Sigmoid())
