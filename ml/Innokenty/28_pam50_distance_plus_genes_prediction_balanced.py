...
for dataset in datasets:
    if(dataset[6:13] == "Batched"):
        ...
        pam_types_cat_dataset = read_pam50_distance_dataset(path, ['sample_name', 'alt_sample_name', 'recurrence', 'study', 'chemo', 'hormone', 'posOutcome', 'tumor_size', 'N',
    ...
    pam_types_cat_dataset = pd.merge(metagx_dataset, pam_types_cat_dataset, left_on="sample_name",
