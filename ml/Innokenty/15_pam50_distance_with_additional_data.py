...
for dataset in datasets:
    if(dataset[6:13] == "Batched"):
        pam_types_cat_dataset = read_pam50_distance_dataset(path, ['sample_name', 'alt_sample_name', 'recurrence', 'study', 'chemo','hormone', 'tumor_size', 'N', 'age_at_initial_pathologic_diagnosis', 'grade', 'posOutcome',  'Basal', 'Her2', 'LumA',	'LumB',	'Normal'])
    else:
