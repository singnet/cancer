...
print("==> pCR (full) ")
print_results_for_field(full_dataset, "pCR")
print("")
print("")


print("==> RFS (full)")
print_results_for_field(full_dataset, "RFS")
print("")
print("")


print("==> DFS (full)")
print_results_for_field(full_dataset, "DFS")
print("")
print("")

print("==> posOutcome (full)")
print_results_for_field(full_dataset, "posOutcome")
print("")
print("")
